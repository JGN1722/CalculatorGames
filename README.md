...
## Bad Guys shooter
Bad guys shooter is a 3D First-Person-Shooter with animated ennemies. It uses a simple but powerful [raycasting](https://fr.wikipedia.org/wiki/Raycasting) algorithm to render
